...
const UserIcon = ({ width = 24, height = 24, className }: Props) => {
  return (
    <>
      <svg
        width={width}
        ...
        <g id='SVGRepo_iconCarrier'>
          ...
          <g fill='none' fillRule='evenodd' transform='translate(3 1)'>
            <g transform='translate(1 5)'>
              ...
              <use fill='#D8D8D8' xlinkHref='#user-a'></use>
            ...
            <mask id='user-d' fill='#ffffff'>
              <use xlinkHref='#user-c'></use>
            </mask>
            <use fill='#000000' fillRule='nonzero' xlinkHref='#user-c'></use>
